...
const Login = ({ onLoginSuccess, onGoHome, onGoToSignup }) => {
  return (
    <div className="login-page">
      <div className="login-container">
        ...
        {/* Nút Continue kích hoạt đăng nhập thành công */}
        <button className="continue-btn" onClick={onLoginSuccess}>Continue</button>
        ...
        <button className="social-btn">
          <svg viewBox="0 0 24 24" className="social-icon">
            <path fill="#1877F2" d="M24 12a12 12 0 1 0-13.875 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385A12.002 12.002 0 0 0 24 12z"/>
            <path fill="white" d="M15.297 12l.532-3.469h-3.328V6.281c0-.949.465-1.874 1.956-1.874h1.514V1.454s-1.374-.235-2.686-.235c-2.741 0-4.533 1.662-4.533 4.669v2.642H7.078v3.469h3.047v8.385a12.09 12.09 0 0 0 3.75 0V12h2.796z"/>
          </svg>
        ...
        <div className="switch-prompt">
          Don't have an account? <span className="switch-link" onClick={onGoToSignup}>Sign up</span>
        </div>
